...
<form method="get" action="View_Form.php" enctype="multipart/form-data">
<center>
<table width="80%" border="0" cellspacing="5" cellpadding="5" style="box-shadow: 25px 25px 75px grey;">
 ...
 <td bgcolor="#6858d2"><div align="center"><a style="color:white;"href="Exam_Form.php">Exam Form</a></div></td>
  ...
  <tr>
    <td height="400" colspan="4" bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="5" cellspacing="5">
      <tr>
...
?>
		<table width="100%" height="100" border="0" cellpadding="5" cellspacing="5">
          ...
          <tr>
		   ...
		   <tr>
            <td></td>
            <td><div align="left"><input type="submit" name="print_form" value="VIEW & PRINT"/></div></td>
          </tr>
        </table></td>
        <td>&nbsp;</td>
      </tr>
