  ...
  <tr>
	...
	<table width="100%" height="100%" border="0" cellpadding="5" cellspacing="5">
      ...
      <tr>
        ...
        <td colspan="3">
<form action="Exam_Form.php" method="get">		
  ...
  <tr>
    <td colspan="3"><table width="100%" border="1" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <th scope="row"><div align="left">PNR No. </div></th>
  ...
  <tr>
    <td colspan="3"><table width="100%" border="1" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <td><div align="left">:447/<?php if(isset($student_id)){echo"$student_id";}?></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<select name="semester" required="" id="semester">
		...
		<input type="button"  value="Get Subjects" onClick="getSubjects()"/>	
  ...
  <tr>
    <td colspan="3"><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
