...
if(isset($_GET['semester']) && isset($_GET['exam_type']) && !empty($_GET['semester']) && !empty($_GET['exam_type'])){
...
exit(header("Location: ./Print_Hall_Ticket.php?msg=Something Went Wrong, Please Contact HOD!&type=error"));	
}
}else{
session_unset();
session_destroy();	
exit(header("Location: ./Staff_Login?msg=Please Login First!&type=error"));	
}
