                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" style=" margin-bottom: 14px;">
                                                            <tbody>
                                                                <tr align="center">
                                                                    <td><img alt="" src="./images/sgbau_logo.png" height="60"></td>
                                                                </tr>
                                                                <tr align="center">
                                                        ...
                                                        <table  style="width: 80%; margin-left:35px;margin-bottom:10px;">
                                                            <tbody>
                                                                <tr style=" text-align: left;">
                                                                    ...
                                                                    <td rowspan="4" style="font-family:Arial;font-weight:bold; font-size:15px; "><img src="<?php echo"$profile_pic"; ?>" height="130px" width="100px" /></td>
                                                                </tr>
...
while($row3=mysqli_fetch_array($res3,MYSQLI_ASSOC)){
	...
	$subject_codecccccc=$row3['subject_code'];
	$credit[$subject_codecccccc]=$row3['credit'];
	}
}
...
$credit_addn['a'.$c]=0;
$credit['c'.$c]=$credit[$subject_cod];

}else{
	
$credit_addn['a'.$c]=($gp*$credit[$subject_cod]);
$credit['c'.$c]=$credit[$subject_cod];	
                                                        ...
                                                        <table align="center" style="width:65%;line-height:60px;">
                                                            <tbody style="font-family: Arial; font-weight: bold; font-size: 13px;">
                                                                <tr>
                                                                    ...
                                                                    <td>
																	<?php
if(isset($credit_addn)){
$caad=count($credit_addn);
$sgdfh=0;
for($r=1;$r<=$caad;$r++){
$sgdfh=$sgdfh+$credit_addn['a'.$r];

}
$jsdagf=0;
for($r=1;$r<=$caad;$r++){
$jsdagf=$jsdagf+$credit['c'.$r];
