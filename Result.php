...
<form method="post" action="Result_Details.php" enctype="multipart/form-data">
<center>
    ...
    <td height="400" colspan="4" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="5" cellspacing="5">
      ...
      <tr>
		...
		<table width="100%" height="100" border="0" cellpadding="5" cellspacing="5">
          <tr>
            <td width="38%"><div align="right">Roll Number: </div></td>
            <td width="62%"><div align="left"><input type="test" name="roll_number"  pattern="[0-9]{1,10}" maxlength="8" required=""/></div></td>
          </tr>
          <tr>
            <td><div align="right">Sem: </div></td>
            <td><div align="left"><select name="sem" required="">
		   ...
		   <tr>
            <td></td>
            <td><div align="left"><input type="submit" name="view_result" value="VIEW"/>
            </div></td>
          </tr>
        </table></td>
        <td>&nbsp;</td>
