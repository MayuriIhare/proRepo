...
<table width="80%" border="0" cellspacing="5" cellpadding="5" style="box-shadow: 25px 25px 75px grey;">
  ...
  <tr>
    <td height="30" colspan="4" bgcolor="#FFFFFF"><div align="right">Welcome <?php if(isset($name)){echo"$name";} if(isset($designation)){echo", $designation";}?>! </div></td>
  </tr>
  <tr>
    <td height="400" colspan="4" bgcolor="#FFFFFF"><center><img src="jdiet.jpg" height="390" width="60%" /> </center></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#FFFFFF"><div align="center">Copyright @ JDIET Yavatmal </div></td>
  </tr>
</table>
</body>
</html>
